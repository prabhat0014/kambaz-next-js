  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe of Chicken Stir Fry:
        <ol id="wd-your-favorite-recipe">
          <li>
            Toss chicken slices with soy sauce, cornstarch, and a pinch of
            pepper in a bowl.
          </li>
          <li>
            Heat 1 tablespoon of oil in a large pan or wok over medium-high
            heat.
          </li>
          <li>
            Add the chicken and stir-fry until browned and cooked through (about
            5–6 minutes), then remove from pan.
          </li>
          <li>
            In the same pan, add remaining oil and sauté garlic for 30 seconds.
          </li>
          <li>
            Add bell pepper, broccoli, and carrot, and stir-fry for 3–4 minutes.
          </li>
          <li>Return chicken to the pan and add oyster sauce and water.</li>
          <li>
